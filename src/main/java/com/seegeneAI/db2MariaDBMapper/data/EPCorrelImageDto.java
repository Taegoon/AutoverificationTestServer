...
public class EPCorrelImageDto {
    ...
    /** 검체유형코드 */
    private String correlatedSourcePath;
    /** 검체유형코드 */
    private String correlatedStoragePath;
    /** 생성일시 */
	...
	public EPCorrelImageDto() {
		...
		this.correlatedSourcePath = "";
		this.correlatedStoragePath = "";
		this.creationDate = null;
		this.updateDate = null;
		this.userId = "";
	}
	
	public EPCorrelImageDto(String lmbCode, String receiptData, int receiptNo, String testCode, String specimenCode,
			int criteriaId, String correlatedLmbCode, String correlatedReceiptDate, int correlatedReceiptNo,
			String correlatedTestCode, String correlatedSpecimenCode, String correlatedSourcePath,
			String correlatedStoragePath, Date creationDate, Date updateDate, String userId) {
		super();
		...
		this.correlatedSourcePath = correlatedSourcePath;
		this.correlatedStoragePath = correlatedStoragePath;
	...
	public String getCorrelatedSourcePath() {
		return correlatedSourcePath;
	}

	public void setCorrelatedSourcePath(String correlatedSourcePath) {
		this.correlatedSourcePath = correlatedSourcePath;
	}

	public String getCorrelatedStoragePath() {
		return correlatedStoragePath;
	}

	public void setCorrelatedStoragePath(String correlatedStoragePath) {
		this.correlatedStoragePath = correlatedStoragePath;
	}
