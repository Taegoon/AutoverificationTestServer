...
public class EPPastCommentDto {
	...
	public EPPastCommentDto(String lmbCode, String receiptData, int receiptNo, String testCode, String specimenCode,
			int criteriaId, String pastLmbCode, String pastReceiptDate, int pastReceiptNo, String pastTestCode,
			String pastSpecimenCode, String pastComment, Date creationDate, Date updateDate, String userId) {
		super();
	...
	public String getPastComment() {
		return pastComment;
	}
	public void setPastComment(String pastComment) {
		this.pastComment = pastComment;
	}
